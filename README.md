...
До фильтра было **42_448_764 rows**, после фильтрации стало **338_018 rows** и удалились ненужные колоноки. Это позволило отобрать из 5,28 GB данных 27 MB нужных. Двигаемся дальше.
