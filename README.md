...
## Как можно улучшить получившиеся результаты?

1. Анализировать поведение по всем категориям. 
    
    Я взял лишь категорию "смартфоны". И это узко. Не все пользователи покупают смартфоны.
2. Анализировать данные за год.
    
    Анализа одного месяца мало, чтобы понять, кто "какой фрукт".

3. При modeling'е использовать несколько алгоритмов.